...
##Class diagram for the Command pattern
[logo]: https://github.com/DemidenkoAndrey/Design-Pattern-in-Ruby/blob/master/command/class_diagram_command.png "Class diagram for the Command pattern"
![alt text][logo]
